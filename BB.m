% B matrix to estimate total accuracy for all transformation methods
% Generated by Ali CAM, re-edited by Hüseyin Topan, April 2018, BEÜ

function B = BB(gdem, Px, model_id)
...
elseif model_id > 31 && model_id < 36
    ...
    if model_id == 32 % second degree (bilinear)
         B (2 * i - 1, 1) = Px(2) + Px(4)  * gdem(i , 5) + 2 * Px(5)  * gdem(i , 4);
         B (2 * i - 1, 2) = Px(3) + Px(4)  * gdem(i , 4) + 2 * Px(6)  * gdem(i , 5);
         B (2 * i    , 1) = Px(8) + Px(10) * gdem(i , 5) + 2 * Px(11) * gdem(i , 4);   
         B (2 * i    , 2) = Px(9) + Px(10) * gdem(i , 4) + 2 * Px(12) * gdem(i , 5);
    elseif model_id == 33 % third degree (cubic)
         B (2 * i - 1, 1) = Px(2)  + Px(4)  * gdem(i , 5) + 2 * Px(5)  * gdem(i , 4) + 2 * Px(7)  * gdem(i , 4) * gdem(i , 5) +     Px(8)  * gdem(i , 5)^2   + 3 * Px(9)  * gdem(i , 4)^2;
         B (2 * i - 1, 2) = Px(3)  + Px(4)  * gdem(i , 4) + 2 * Px(6)  * gdem(i , 5) +     Px(7)  * gdem(i , 4)^2   + 2 * Px(8)  * gdem(i , 4) * gdem(i , 5) + 3 * Px(10) * gdem(i , 5)^2;
         B (2 * i    , 1) = Px(12) + Px(14) * gdem(i , 5) + 2 * Px(15) * gdem(i , 4) + 2 * Px(17) * gdem(i , 4) * gdem(i , 5) +     Px(18) * gdem(i , 5)^2   + 3 * Px(19) * gdem(i , 4)^2;
         B (2 * i    , 2) = Px(13) + Px(14) * gdem(i , 4) + 2 * Px(16) * gdem(i , 5) +     Px(17) * gdem(i , 4)^2   + 2 * Px(18) * gdem(i , 4) * gdem(i , 5) + 3 * Px(20) * gdem(i , 5)^2;
    elseif model_id == 34 % fourth degree (quartic)
        B (2 * i - 1, 1) = Px(2) + Px(4) * gdem(i , 5) + 2 * Px(5) * gdem(i , 4) + 2 * Px(7) * gdem(i , 4) * gdem(i , 5) + Px(8) * gdem(i , 5)^2 + 3 * Px(9)  * gdem(i , 4)^2 ...
            + 3 * Px(11) * gdem(i , 4)^2 * gdem(i , 5) + Px(12) * gdem(i , 5)^3 + 4 * Px(13) * gdem(i , 4)^3 + 2 * Px(15) * gdem(i , 4) * gdem(i , 5)^2;
        B (2 * i - 1, 2) = Px(3) + Px(4) * gdem(i , 4) + 2 * Px(6) * gdem(i , 5) + Px(7) * gdem(i , 4)^2 + 2 * Px(8) * gdem(i , 4) * gdem(i , 5) + 3 * Px(10) * gdem(i , 5)^2 ...
            + Px(11) * gdem(i , 4)^3 + 3 * Px(12) * gdem(i , 4) * gdem(i , 5)^2 + 4 * Px(14) * gdem(i , 5)^3 + 2 * Px(15) * gdem(i , 4)^2 * gdem(i , 5);
        B (2 * i    , 1) = Px(17) + Px(19) * gdem(i , 5) + 2 * Px(20) * gdem(i , 4) + 2 * Px(22) * gdem(i , 4) * gdem(i , 5) + Px(23) * gdem(i , 5)^2 + 3 * Px(24) * gdem(i , 4)^2 ...
            + 3 * Px(26) * gdem(i , 4)^2 * gdem(i , 5) + Px(27) * gdem(i , 5)^3 + 4 * Px(28) * gdem(i , 4)^3 + 2 * Px(30) * gdem(i , 4) * gdem(i , 5)^2;
        B (2 * i    , 2) = Px(18) + Px(19) * gdem(i , 4) + 2 * Px(21) * gdem(i , 5) + Px(22) * gdem(i , 4)^2 + 2 * Px(23) * gdem(i , 4) * gdem(i , 5) + 3 * Px(25) * gdem(i , 5)^2 ...
            + Px(26) * gdem(i , 4)^3 + 3 * Px(27) * gdem(i , 4) * gdem(i , 5)^2 + 4 * Px(29) * gdem(i , 5)^3 + 2 * Px(30) * gdem(i , 4)^2 * gdem(i , 5);
    elseif model_id == 35 % fifth degree (quintic)
        B (2 * i - 1, 1) = Px(2) + Px(4) * gdem(i , 5) + 2 * Px(5) * gdem(i , 4) + 2 * Px(7) * gdem(i , 4) * gdem(i , 5) + Px(8) * gdem(i , 5)^2 + 3 * Px(9)  * gdem(i , 4)^2 ...
            + 3 * Px(11) * gdem(i , 4)^2 * gdem(i , 5) + Px(12) * gdem(i , 5)^3 + 4 * Px(13) * gdem(i , 4)^3 + 2 * Px(15) * gdem(i , 4) * gdem(i , 5)^2 ...
            + 3 * Px(16) * gdem(i , 4)^2 * gdem(i , 5)^2 + 2 * Px(17) * gdem(i , 4) * gdem(i , 5)^3 + 5 * Px(18) * gdem(i , 4)^4 + 4 * Px(20) * gdem(i , 4)^3 * gdem(i , 5) + Px(21) * gdem(i , 5)^4;
        B (2 * i - 1, 2) = Px(3) + Px(4) * gdem(i , 4) + 2 * Px(6) * gdem(i , 5) + Px(7) * gdem(i , 4)^2 + 2 * Px(8) * gdem(i , 4) * gdem(i , 5) + 3 * Px(10) * gdem(i , 5)^2 ...
            + Px(11) * gdem(i , 4)^3 + 3 * Px(12) * gdem(i , 4) * gdem(i , 5)^2 + 4 * Px(14) * gdem(i , 5)^3 + 2 * Px(15) * gdem(i , 4)^2 * gdem(i , 5) ...
            + 2 * Px(16) * gdem(i , 4)^3 * gdem(i , 5) + 3 * Px(17) * gdem(i , 4)^2 * gdem(i , 5)^2 + 5 * Px(19) * gdem(i , 5)^4 + Px(20) * gdem(i , 4)^4 + 4 * Px(21) * gdem(i , 4) * gdem(i , 5)^3;
        B (2 * i    , 1) = Px(23) + Px(25) * gdem(i , 5) + 2 * Px(26) * gdem(i , 4) + 2 * Px(28) * gdem(i , 4) * gdem(i , 5) + Px(29) * gdem(i , 5)^2 + 3 * Px(30) * gdem(i , 4)^2 ...
            + 3 * Px(32) * gdem(i , 4)^2 *gdem(i , 5) + Px(33) * gdem(i , 5)^3 + 4 * Px(34) * gdem(i , 4)^3 + 2 * Px(22) * gdem(i , 4) * gdem(i , 5)^2 ...
            + 3 * Px(37) * gdem(i , 4)^2 * gdem(i , 5)^2 + 2 * Px(38) * gdem(i , 4) * gdem(i , 5)^3 + 5 * Px(39) * gdem(i , 4)^4 + 4 * Px(41) * gdem(i , 4)^3 * gdem(i , 5) + Px(42) * gdem(i , 5)^4;
        B (2 * i    , 2) = Px(24) + Px(25) * gdem(i , 4) + 2 * Px(27) * gdem(i , 5) + Px(28) * gdem(i , 4)^2 + 2 * Px(29) * gdem(i , 4) * gdem(i , 5) + 3 * Px(31) * gdem(i , 5)^2 ...
            + Px(32) * gdem(i , 4)^3 + 3 * Px(33) * gdem(i , 4) * gdem(i , 5)^2 + 4 * Px(34) * gdem(i , 5)^3 + 2 * Px(36) * gdem(i , 4)^2 * gdem(i , 5) ...
            + 2 * Px(37) * gdem(i , 4)^3 * gdem(i , 5) + 3 * Px(38) * gdem(i , 4)^2 * gdem(i , 5)^2 + 5 * Px(40) * gdem(i , 5)^4 + Px(41) * gdem(i , 4)^4 + 4 * Px(42) * gdem(i , 4) * gdem(i , 5)^3;
    end
        
%% Affine projection
elseif model_id == 41
    B (2 * i - 1, :) = [Px(2) Px(3) Px(4)];
    B (2 * i    , :) = [Px(6) Px(7) Px(8)];
elseif model_id == 42
    B (2 * i - 1, :) = [(Px(2) + Px(5)  * gdem(i , 6) + 2 * Px(7) * gdem(i , 4)) (Px(3) + Px(6) * gdem(i , 6))                         (Px(4)  + Px(5)  * gdem(i , 4) + Px(6)  * gdem(i , 5))];
    B (2 * i    , :) = [(Px(9) + Px(12) * gdem(i , 6) + Px(14) * gdem(i , 5))    (Px(10) + Px(13) * gdem(i , 6) + Px(14) * gdem(i , 4)) (Px(11) + Px(12) * gdem(i , 4) + Px(13) * gdem(i , 5))];
elseif model_id == 43
    B (2 * i - 1, :) = [(Px(2) + Px(5)  * gdem(i , 6)) (Px(3) + Px(6)  * gdem(i , 6)) (Px(4)  + Px(5)  * gdem(i , 4) + Px(6)  * gdem(i , 5))];
    B (2 * i    , :) = [(Px(8) + Px(11) * gdem(i , 6)) (Px(9) + Px(12) * gdem(i , 6)) (Px(10) + Px(11) * gdem(i , 4) + Px(12) * gdem(i , 5))];
%% Projective
elseif model_id == 5
    denominator(i) = 1 + Px(4 : 5)' * gdem(i , 9 : 10)';
        
    B (2 * i - 1, :) = denominator(i)^-1 * [(Px(2) - Px(7) * gdem(i , 7)) (Px(3) - Px(8) * gdem(i , 7))];
    B (2 * i    , :) = denominator(i)^-1 * [(Px(5) - Px(7) * gdem(i , 8)) (Px(6) - Px(8) * gdem(i , 8))];
%% DLT
elseif model_id == 6
    denominator(i) = 1 + Px(5 : 7)' * gdem(i , 9 : 11)';
    
    B (2 * i - 1, :) = denominator(i)^-1 * [(Px(2) - Px(5) * gdem(i , 7)) (Px(3 ) - Px(6) * gdem(i , 7)) (Px(3 ) - Px(7) * gdem(i , 7))];
    B (2 * i    , :) = denominator(i)^-1 * [(Px(9) - Px(5) * gdem(i , 8)) (Px(10) - Px(6) * gdem(i , 8)) (Px(11) - Px(7) * gdem(i , 8))];    
...
elseif model_id > 70 && model_id < 74
    ...
    if  model_id == 71
        ...
        B (2 * i - 1, :) = [((Px(2) * f2(i) - Px(5)  * f1(i)) / f2(i)^2) ((Px(3)  * f2(i) - Px(6)  * f1(i)) / f2(i)^2) ((Px(4)  * f2(i) - Px(7)  * f1(i)) / f2(i)^2)]; 
        B (2 * i    , :) = [((Px(9) * f4(i) - Px(12) * f3(i)) / f4(i)^2) ((Px(10) * f4(i) - Px(13) * f3(i)) / f4(i)^2) ((Px(11) * f4(i) - Px(12) * f3(i)) / f4(i)^2)]; 
