...
gcp(: , 2) = gcp(: , 2) / (40000 / 955);
icp(: , 2) = icp(: , 2) / (40000 / 955);
gcp(: , 3) = gcp(: , 3) / (40068 / 957);
icp(: , 3) = icp(: , 3) / (40068 / 957);
...
if meta(8) == 0
    xlabel('c (pixel)','FontSize',20);
    ylabel('r (pixel)','FontSize',20);
elseif meta(8) == 1
    xlabel('c (piksel)','FontSize',20);
    ylabel('r (piksel)','FontSize',20);
end
